...
import { defineEventHandler, handleCacheHeaders, splitCookiesString, createEvent, fetchWithEvent, isEvent, eventHandler, setHeaders, sendRedirect, proxyRequest, getRequestHeader, setResponseHeaders, setResponseStatus, send, getRequestHeaders, setResponseHeader, appendResponseHeader, getRequestURL, getResponseHeader, getResponseStatus, createError, removeResponseHeader, getQuery as getQuery$1, handleCors, getRequestIP, readMultipartFormData, readBody, lazyEventHandler, useBase, createApp, createRouter as createRouter$1, toNodeListener, getRouterParam, getResponseStatusText } from 'file:///home/louis/repo/web/nuxt-laravel-chat-app/node_modules/h3/dist/index.mjs';
import { Server } from 'node:http';
import { resolve, dirname, join } from 'node:path';
import nodeCrypto from 'node:crypto';
import { parentPort, threadId } from 'node:worker_threads';
import { escapeHtml } from 'file:///home/louis/repo/web/nuxt-laravel-chat-app/node_modules/@vue/shared/dist/shared.cjs.js';
import { createRenderer, getRequestDependencies, getPreloadLinks, getPrefetchLinks } from 'file:///home/louis/repo/web/nuxt-laravel-chat-app/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { parseURL, withoutBase, joinURL, getQuery, withQuery, withTrailingSlash, joinRelativeURL, decodePath, withLeadingSlash, withoutTrailingSlash } from 'file:///home/louis/repo/web/nuxt-laravel-chat-app/node_modules/ufo/dist/index.mjs';
import destr, { destr as destr$1 } from 'file:///home/louis/repo/web/nuxt-laravel-chat-app/node_modules/destr/dist/index.mjs';
import { createHooks } from 'file:///home/louis/repo/web/nuxt-laravel-chat-app/node_modules/hookable/dist/index.mjs';
import { createFetch, Headers as Headers$1 } from 'file:///home/louis/repo/web/nuxt-laravel-chat-app/node_modules/ofetch/dist/node.mjs';
import { fetchNodeRequestHandler, callNodeRequestHandler } from 'file:///home/louis/repo/web/nuxt-laravel-chat-app/node_modules/node-mock-http/dist/index.mjs';
import { createStorage, prefixStorage } from 'file:///home/louis/repo/web/nuxt-laravel-chat-app/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file:///home/louis/repo/web/nuxt-laravel-chat-app/node_modules/unstorage/drivers/fs.mjs';
import unstorage_47drivers_47lru_45cache from 'file:///home/louis/repo/web/nuxt-laravel-chat-app/node_modules/unstorage/drivers/lru-cache.mjs';
import { digest, hash as hash$1 } from 'file:///home/louis/repo/web/nuxt-laravel-chat-app/node_modules/ohash/dist/index.mjs';
import { klona } from 'file:///home/louis/repo/web/nuxt-laravel-chat-app/node_modules/klona/dist/index.mjs';
import defu, { defuFn, createDefu } from 'file:///home/louis/repo/web/nuxt-laravel-chat-app/node_modules/defu/dist/defu.mjs';
import { snakeCase } from 'file:///home/louis/repo/web/nuxt-laravel-chat-app/node_modules/scule/dist/index.mjs';
import { getContext } from 'file:///home/louis/repo/web/nuxt-laravel-chat-app/node_modules/unctx/dist/index.mjs';
import { toRouteMatcher, createRouter } from 'file:///home/louis/repo/web/nuxt-laravel-chat-app/node_modules/radix3/dist/index.mjs';
import { readFile } from 'node:fs/promises';
import consola, { consola as consola$1 } from 'file:///home/louis/repo/web/nuxt-laravel-chat-app/node_modules/consola/dist/index.mjs';
import { ErrorParser } from 'file:///home/louis/repo/web/nuxt-laravel-chat-app/node_modules/youch-core/build/index.js';
import { Youch } from 'file:///home/louis/repo/web/nuxt-laravel-chat-app/node_modules/nitropack/node_modules/youch/build/index.js';
import { SourceMapConsumer } from 'file:///home/louis/repo/web/nuxt-laravel-chat-app/node_modules/source-map/source-map.js';
import { AsyncLocalStorage } from 'node:async_hooks';
import { stringify, uneval } from 'file:///home/louis/repo/web/nuxt-laravel-chat-app/node_modules/devalue/index.js';
import { captureRawStackTrace, parseRawStackTrace } from 'file:///home/louis/repo/web/nuxt-laravel-chat-app/node_modules/errx/dist/index.js';
import { isVNode, toValue, isRef } from 'file:///home/louis/repo/web/nuxt-laravel-chat-app/node_modules/vue/index.mjs';
import { promises } from 'node:fs';
import { fileURLToPath } from 'node:url';
import { dirname as dirname$1, resolve as resolve$1, basename, isAbsolute } from 'file:///home/louis/repo/web/nuxt-laravel-chat-app/node_modules/pathe/dist/index.mjs';
import { getIcons } from 'file:///home/louis/repo/web/nuxt-laravel-chat-app/node_modules/@iconify/utils/lib/index.mjs';
import { collections } from 'file:///home/louis/repo/web/nuxt-laravel-chat-app/.nuxt/nuxt-icon-server-bundle.mjs';
import { FilterXSS } from 'file:///home/louis/repo/web/nuxt-laravel-chat-app/node_modules/xss/lib/index.js';
import { createHead as createHead$1, propsToString, renderSSRHead } from 'file:///home/louis/repo/web/nuxt-laravel-chat-app/node_modules/unhead/dist/server.mjs';
import { renderToString } from 'file:///home/louis/repo/web/nuxt-laravel-chat-app/node_modules/vue/server-renderer/index.mjs';
import { walkResolver } from 'file:///home/louis/repo/web/nuxt-laravel-chat-app/node_modules/unhead/dist/utils.mjs';
import { ipxFSStorage, ipxHttpStorage, createIPX, createIPXH3Handler } from 'file:///home/louis/repo/web/nuxt-laravel-chat-app/node_modules/ipx/dist/index.mjs';

const serverAssets = [{"baseName":"server","dir":"/home/louis/repo/web/nuxt-laravel-chat-app/server/assets"}];
...
storage$1.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/home/louis/repo/web/nuxt-laravel-chat-app","watchOptions":{"ignored":[null]}}));
storage$1.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/home/louis/repo/web/nuxt-laravel-chat-app/server","watchOptions":{"ignored":[null]}}));
storage$1.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/home/louis/repo/web/nuxt-laravel-chat-app/.nuxt"}));
storage$1.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/home/louis/repo/web/nuxt-laravel-chat-app/.nuxt/cache"}));
storage$1.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"/home/louis/repo/web/nuxt-laravel-chat-app/.data/kv"}));
...
const rootDir = "/home/louis/repo/web/nuxt-laravel-chat-app";

const appHead = {"meta":[{"charset":"utf-8"},{"name":"viewport","content":"width=device-width, initial-scale=1"}],"link":[{"rel":"icon","type":"image/x-icon","href":"/favicon.ico"}],"style":[],"script":[],"noscript":[],"title":"Home","titleTemplate":"%s | LaravelNuxt Boilerplate"};
...
const _L7OguVcs7wa1iSPxZ9Bsvc_XS936mEbWsGEIKIrkxxM = (nitroApp) => {
...
const _kbggbhxGpf7JfzxBPqBhr64yT8RQDUTP7rplSDaN0 = (function(nitro) {
...
const _6PKFVzwKheQ5c5dEX0KER8WL87XamIQY7cZtHToO30 = defineNitroPlugin(async (nitroApp) => {
...
const sriHashes = {"/_nuxt/builds/meta/8e666e70-40ff-41ba-9ede-604e549bfdaf.json":"sha384-0qI7x4Pjqjj0AeE8dIhQUTfElUp/2IMx8Vl8X/cREdyAfHNwpbKCxtpUHFbt5p8w","/_nuxt/builds/meta/dev.json":"sha384-NxFvEF4Pd0QiTjdCuR/aIRbelwBBVASsBGxrn12oPTacjSVpY9FZ8UYBiYHPOhuo","/_nuxt/builds/latest.json":"sha384-k0k+w3otAG7GRcwSKzQEBbCrnV/yRmJ2vq9WOXhVc834BRKtQVo1kkhfqynD2bfc"};
...
const _t6UiTLQ5PgHjCHDeK4DMfbsxwqsCdaWMouD_2KHpniQ = defineNitroPlugin((nitroApp) => {
...
const _pakmVGUvlwfK4KLvOvQyu5qztMTuK5wy1QFWYm0PlvQ = defineNitroPlugin((nitroApp) => {
  {
    return;
  }
});
...
const __UGjFmyZqtPcCh6n236PIxuvMce3KAEyPQFKKwjNgZc = defineNitroPlugin((nitroApp) => {
...
const _4hM0OuMCJTSB7H0fzeWLCVsIaLkrU6ewHZJD8h_a6s8 = defineNitroPlugin((nitroApp) => {
...
const _YXQm1GrZjAE0wXP62a8X7yoza9rp0iG222yEMh8XNWw = defineNitroPlugin((nitroApp) => {
  {
    return;
  }
});

const _yQhQRz5xDQG8wKOEFRWSgUjq_E4WREhxYePwmbFE4nA = defineNitroPlugin((nitroApp) => {
...
const _YUBQOW_wAdOWSkirH3TqY7rYBXAt8cFvqRSAQ_4Hdpg = defineNitroPlugin((nitroApp) => {
...
const _yOzDbTGsZrSC7IjOf7sBGLaYrGKhUBMvSrtBtDzTxbY = defineNitroPlugin(async (nitroApp) => {
  {
...
const plugins = [
  _L7OguVcs7wa1iSPxZ9Bsvc_XS936mEbWsGEIKIrkxxM,
_kbggbhxGpf7JfzxBPqBhr64yT8RQDUTP7rplSDaN0,
_6PKFVzwKheQ5c5dEX0KER8WL87XamIQY7cZtHToO30,
_t6UiTLQ5PgHjCHDeK4DMfbsxwqsCdaWMouD_2KHpniQ,
_pakmVGUvlwfK4KLvOvQyu5qztMTuK5wy1QFWYm0PlvQ,
__UGjFmyZqtPcCh6n236PIxuvMce3KAEyPQFKKwjNgZc,
_4hM0OuMCJTSB7H0fzeWLCVsIaLkrU6ewHZJD8h_a6s8,
_YXQm1GrZjAE0wXP62a8X7yoza9rp0iG222yEMh8XNWw,
_yQhQRz5xDQG8wKOEFRWSgUjq_E4WREhxYePwmbFE4nA,
_YUBQOW_wAdOWSkirH3TqY7rYBXAt8cFvqRSAQ_4Hdpg,
_yOzDbTGsZrSC7IjOf7sBGLaYrGKhUBMvSrtBtDzTxbY
];
...
const _HZrMpE = eventHandler((event) => {
...
const _79zgOJ = defineCachedEventHandler(async (event) => {
...
const _Z8HTxo = defineEventHandler((event) => {
  const rules = resolveSecurityRules(event);
...
const _BIx0N0 = defineEventHandler((event) => {
  const rules = resolveSecurityRules(event);
...
const _l51MAS = defineEventHandler((event) => {
  const rules = resolveSecurityRules(event);
...
const _GoJbfi = defineEventHandler(async (event) => {
  const rules = resolveSecurityRules(event);
...
const _0CL4wt = defineEventHandler(async (event) => {
  const rules = resolveSecurityRules(event);
...
const getServerEntry = () => import('file:///home/louis/repo/web/nuxt-laravel-chat-app/.nuxt/dist/server/server.mjs').then((r) => r.default || r);
const getClientManifest = () => import('file:///home/louis/repo/web/nuxt-laravel-chat-app/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
...
const _DB8NUP = lazyEventHandler(() => {
...
const _lazy_W89vRl = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '', handler: _HZrMpE, lazy: false, middleware: true, method: undefined },
  { route: '/__nuxt_error', handler: _lazy_W89vRl, lazy: true, middleware: false, method: undefined },
  { route: '/api/_nuxt_icon/:collection', handler: _79zgOJ, lazy: false, middleware: false, method: undefined },
  { route: '', handler: _Z8HTxo, lazy: false, middleware: false, method: undefined },
  { route: '', handler: _BIx0N0, lazy: false, middleware: false, method: undefined },
  { route: '', handler: _l51MAS, lazy: false, middleware: false, method: undefined },
  { route: '', handler: _GoJbfi, lazy: false, middleware: false, method: undefined },
  { route: '', handler: _0CL4wt, lazy: false, middleware: false, method: undefined },
  { route: '/__nuxt_island/**', handler: _SxA8c9, lazy: false, middleware: false, method: undefined },
  { route: '/_ipx/**', handler: _DB8NUP, lazy: false, middleware: false, method: undefined },
  { route: '/_fonts/**', handler: _lazy_W89vRl, lazy: true, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_W89vRl, lazy: true, middleware: false, method: undefined }
];
